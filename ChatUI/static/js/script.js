document.getElementById("submitButton").addEventListener("click", function() {
    ...
    if (selectedStudentType) {
        ...
        // Check if "Software Engineering Coursework" or "Four Year Plan" is selected when "Send" is clicked
        if (softwareEngineeringCourseworkOption && softwareEngineeringCourseworkOption.checked) {
        ...
        } else if (fourYearPlanOption && fourYearPlanOption.checked) {
